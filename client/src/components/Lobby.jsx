        ...
        <div className="lobby-card">
            ...
            <div className="edition-cards-container">
              <div className="edition-cards-scroll">
                {GAME_EDITIONS.map((edition) => (
                  <div
                    key={edition.id}
                    className={`edition-card ${settings.gameEdition === edition.id || (edition.id === 'classic' && !settings.gameEdition) ? 'selected' : ''} ${!edition.available ? 'disabled' : ''}`}
          ...
          <div className="settings-section">
            ...
            <div className="settings-list">
              ...
              <div className="setting-toggle-row">
                <div className="setting-info">
                  <span className="setting-label">Number of Players</span>
                  <span className="setting-description">Maximum players allowed</span>
                </div>
                {isHost ? (
                  <select
                  ...
                  <span className="setting-value">{settings.maxPlayers || 6} Players</span>
                )}
              </div>
              ...
              <div className="setting-toggle-row">
                ...
                {isHost ? (
                  <div className="starting-cash-control">
                    {showCustomCash ? (
                      <div className="custom-cash-input">
                      ...
                      <select
                        className="setting-select"
                        value={[500, 1000, 1500, 2000, 2500, 3000].includes(settings.startingCash)
                          ? settings.startingCash : 'custom'}
                      ...
                      >
                        ...
                        <option value="custom">
                          {![500, 1000, 1500, 2000, 2500, 3000].includes(settings.startingCash)
                            ? formatCurrency(settings.startingCash)
                            : 'Custom...'}
                        </option>
                      </select>
                    )}
              ...
              <SettingToggle
                ...
                settingKey="freeParking"
                description="Fines go to pot, collect on Free Parking"
              />
            </div>
          </div>
