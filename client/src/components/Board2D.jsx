  ...
  const renderTopTile = (space, pos, propertyState) => {
    ...
    return (
      <g>
        ...
        {space.price && <text x={pos.w/2} y={priceGap + priceFontSize} textAnchor="middle" fontSize={priceFontSize} fill={TILE_COLORS.price} fontWeight="bold">${space.price}</text>}
  ...
  const renderRailroad = (space, pos, side, propertyState) => {
    ...
    if (side === 'bottom') {
      ...
      return (
        <g>
          <rect width={pos.w} height={pos.h} fill={TILE_COLORS.background} stroke={TILE_COLORS.border} strokeWidth="1.5" rx={3}/>
          <text x={pos.w/2} y={priceGap + priceFontSize} textAnchor="middle" fontSize={priceFontSize} fill={TILE_COLORS.price} fontWeight="bold">$200</text>
  ...
  const renderUtility = (space, pos, side, propertyState) => {
    ...
    if (side === 'bottom') {
      ...
      return (
        <g>
          <rect width={pos.w} height={pos.h} fill={TILE_COLORS.background} stroke={TILE_COLORS.border} strokeWidth="1.5" rx={3}/>
          <text x={pos.w/2} y={priceGap + priceFontSize} textAnchor="middle" fontSize={priceFontSize} fill={TILE_COLORS.price} fontWeight="bold">$150</text>
